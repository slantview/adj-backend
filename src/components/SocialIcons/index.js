        ...
        <div className={className}>
            { facebook &&
                <div className={itemClassName}>
                    <a href={facebook} target="_new" className="hover:text-blue-400 m-0">
            ...
            { instagram &&
                <div className={itemClassName}>
                    <a href={instagram} target="_new" className="hover:text-blue-400 m-0">
            ...
            { twitter &&
                <div className={itemClassName}>
                    <a href={twitter} target="_new" className="hover:text-blue-400 m-0">
            ...
            { twitch &&
                <div className={itemClassName}>
                    <a href={twitch} target="_new" className="hover:text-blue-400 m-0">
            ...
            { youtube &&
                <div className={itemClassName}>
                    <a href={youtube} target="_new" className="hover:text-blue-400 m-0">
            ...
            { patreon &&
                <div className={itemClassName}>
                    <a href={patreon} target="_new" className="hover:text-blue-400 m-0">
            ...
            { discord &&
                <div className={itemClassName}>
                    <a href={discord} target="_new" className="hover:text-blue-400 m-0">
